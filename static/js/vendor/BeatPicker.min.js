...
BeatPicker.prototype={dateInputNode:null,pickerNode:null,daysSimple:"Do Lu Ma Mi Ju Vi Sá".split(" "),daysFull:[],monthsSimple:"Ene Feb Mar Abr May Jun Jul Ago Sep Oct Nov Dic".split(" "),monthsFull:"Enero Febrero Marzo Abril Mayo Junio Julio Agosto Septiembre Octubre Noviembre Diciembre".split(" "),startDate:new Date,currentDate:new Date,dateFormat:{separator:"-",format:["YYYY","MM","DD"]},modules:{header:!0,footer:!0,daysOfTheWeek:!0,navBar:!0,today:!0,gotoDate:!0,icon:!0,clear:!0},selectionRule:{single:!0,
